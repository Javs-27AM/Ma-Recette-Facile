...
$(document).ready(function () {
  ...
  $(document).on("click", ".card-recipe", function () {
    ...
    if (target.closest(".fa-heart, .fa-share").length) {
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data.nombreUsuario) {
          ...
          if (
            confirm(
              "Debes iniciar sesión para agregar una receta. ¿Quieres iniciar sesión ahora?"
            )
          ) {
            $("#loginModal").show();
          }
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.nombreUsuario) {
          ...
          if (
            confirm(
              "Debes iniciar sesión para marcar esta receta como favorita. ¿Quieres iniciar sesión ahora?"
            )
          ) {
            $("#loginModal").show();
          }
